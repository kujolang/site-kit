...
Use this component when you need the SiteKit-native version of `old-components/testing-pricing-2.html`.
...
See testing-pricing-2.schema.json for the source contract.
...
- Read testing-pricing-2.schema.json before using or changing this component.
...
See examples.json and testing-pricing-2.html.
