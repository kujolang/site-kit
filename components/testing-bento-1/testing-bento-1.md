...
Use this component when you need the SiteKit-native version of `old-components/testing-bento-1.html`.
...
See testing-bento-1.schema.json for the source contract.
...
- Read testing-bento-1.schema.json before using or changing this component.
...
See examples.json and testing-bento-1.html.
