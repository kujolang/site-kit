...
Use this component when you need the SiteKit-native version of `old-components/testing-footer-6.html`.
...
See testing-footer-6.schema.json for the source contract.
...
- Read testing-footer-6.schema.json before using or changing this component.
...
See examples.json and testing-footer-6.html.
