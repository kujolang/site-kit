...
Use this component when you need the SiteKit-native version of `old-components/testing-footer-5.html`.
...
See testing-footer-5.schema.json for the source contract.
...
- Read testing-footer-5.schema.json before using or changing this component.
...
See examples.json and testing-footer-5.html.
