# FAQ with Clean Load-in Animations
...
Use this component when you need the SiteKit-native version of `old-components/testing-faq-4.html`.
...
See testing-faq-4.schema.json for the source contract.
...
- Read testing-faq-4.schema.json before using or changing this component.
...
See examples.json and testing-faq-4.html.
