...
Use this component when you need the SiteKit-native version of `old-components/testing-cta-1.html`.
...
See testing-cta-1.schema.json for the source contract.
...
- Read testing-cta-1.schema.json before using or changing this component.
...
See examples.json and testing-cta-1.html.
