...
A source-specific pricing layout using semantic plan cards.

## When To Use

Use this component when you need the SiteKit-native version of `old-components/testing-pricing-1.html`.
...
See testing-pricing-1.schema.json for the source contract.
...
- Read testing-pricing-1.schema.json before using or changing this component.
...
See examples.json and testing-pricing-1.html.
