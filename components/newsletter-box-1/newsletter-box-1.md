...
Use this component when you need the SiteKit-native version of `old-components/newsletter-box-1.html`.
...
See newsletter-box-1.schema.json for the source contract.
...
- Read newsletter-box-1.schema.json before using or changing this component.
...
See examples.json and newsletter-box-1.html.
