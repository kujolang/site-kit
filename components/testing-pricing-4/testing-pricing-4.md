...
Use this component when you need the SiteKit-native version of `old-components/testing-pricing-4.html`.
...
See testing-pricing-4.schema.json for the source contract.
...
- Read testing-pricing-4.schema.json before using or changing this component.
...
See examples.json and testing-pricing-4.html.
