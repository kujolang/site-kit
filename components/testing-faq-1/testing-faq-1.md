...
Use this component when you need the SiteKit-native version of `old-components/testing-faq-1.html`.
...
See testing-faq-1.schema.json for the source contract.
...
- Read testing-faq-1.schema.json before using or changing this component.
...
See examples.json and testing-faq-1.html.
