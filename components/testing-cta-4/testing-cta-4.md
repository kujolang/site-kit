...
Use this component when you need the SiteKit-native version of `old-components/testing-cta-4.html`.
...
See testing-cta-4.schema.json for the source contract.
...
- Read testing-cta-4.schema.json before using or changing this component.
...
See examples.json and testing-cta-4.html.
