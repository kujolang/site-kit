...
Use this component when you need the SiteKit-native version of `old-components/bento-grid-7.html`.
...
See bento-grid-7.schema.json for the source contract.
...
- Read bento-grid-7.schema.json before using or changing this component.
...
See examples.json and bento-grid-7.html.
