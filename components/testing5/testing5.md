...
Use this component when you need the SiteKit-native version of `old-components/testing5.html`.
...
See testing5.schema.json for the source contract.
...
- Read testing5.schema.json before using or changing this component.
...
See examples.json and testing5.html.
