...
Use this component when you need the SiteKit-native version of `old-components/testing-bento-grid-4.html`.
...
See testing-bento-grid-4.schema.json for the source contract.
...
- Read testing-bento-grid-4.schema.json before using or changing this component.
...
See examples.json and testing-bento-grid-4.html.
