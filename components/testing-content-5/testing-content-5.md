...
Use this component when you need the SiteKit-native version of `old-components/testing-content-5.html`.
...
See testing-content-5.schema.json for the source contract.
...
- Read testing-content-5.schema.json before using or changing this component.
...
See examples.json and testing-content-5.html.
