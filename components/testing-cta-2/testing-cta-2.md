...
Use this component when you need the SiteKit-native version of `old-components/testing-cta-2.html`.
...
See testing-cta-2.schema.json for the source contract.
...
- Read testing-cta-2.schema.json before using or changing this component.
...
See examples.json and testing-cta-2.html.
