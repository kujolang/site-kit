...
Use this component when you need the SiteKit-native version of `old-components/newsletter-box-4.html`.
...
See newsletter-box-4.schema.json for the source contract.
...
- Read newsletter-box-4.schema.json before using or changing this component.
...
See examples.json and newsletter-box-4.html.
