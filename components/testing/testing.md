...
A source-specific showcase section adapted from an old component.

## When To Use

Use this component when you need the SiteKit-native version of `old-components/testing.html`.
...
See testing.schema.json for the source contract.
...
- Read testing.schema.json before using or changing this component.
...
See examples.json and testing.html.
