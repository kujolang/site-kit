...
Use this component when you need the SiteKit-native version of `old-components/testing-newsletter-1.html`.
...
See testing-newsletter-1.schema.json for the source contract.
...
- Read testing-newsletter-1.schema.json before using or changing this component.
...
See examples.json and testing-newsletter-1.html.
