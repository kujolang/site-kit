...
Use this component when you need the SiteKit-native version of `old-components/testing-footer-1.html`.
...
See testing-footer-1.schema.json for the source contract.
...
- Read testing-footer-1.schema.json before using or changing this component.
...
See examples.json and testing-footer-1.html.
