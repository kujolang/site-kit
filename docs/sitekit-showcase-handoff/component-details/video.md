...
- schema: `components/video/video.schema.json`
- template: `components/video/video.html`
- css: `components/video/video.css`
- documentation: `components/video/video.md`
- examples: `components/video/examples.json`

Load `dist/sitekit.css`; root selector `.sk-video`. No component JavaScript export.
...
Declared variants: embed, compact.
...
| --- | --- | --- |
| default | source template | components/video/video.html |
| focus | CSS selector; may target descendants | components/video/video.css |
...
```html
<figure class="sk-video"><div role="img" aria-label="Video preview">16:9 Video</div><figcaption>Accessible video frame with caption.</figcaption></figure>
```
...
Actual CSS variables: `--sk-border-1`, `--sk-border-default`, `--sk-focus-offset`, `--sk-focus-ring`, `--sk-focus-width`, `--sk-font-mono`, `--sk-space-3`, `--sk-surface-raised`, `--sk-text-muted`, `--sk-text-secondary`.

## Caveats and documentation

- Source div is role=img, not video/iframe. Native media controls, tracks and consent are consumer work.

CONTRADICTS IMPLEMENTATION: Source div is role=img, not video/iframe. Native media controls, tracks and consent are consumer work.
