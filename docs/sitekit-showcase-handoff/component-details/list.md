...
- schema: `components/list/list.schema.json`
- template: `components/list/list.html`
- css: `components/list/list.css`
- documentation: `components/list/list.md`
- examples: `components/list/examples.json`

Load `dist/sitekit.css`; root selector `.sk-list`. No component JavaScript export.
...
Declared variants: unordered, compact.
...
| --- | --- | --- |
| default | source template | components/list/list.html |
| focus | CSS selector; may target descendants | components/list/list.css |
...
```html
<ul class="sk-list"><li>Semantic markup</li><li>Tokenized spacing</li><li>Readable hierarchy</li></ul>
```
...
Actual CSS variables: `--sk-focus-offset`, `--sk-focus-ring`, `--sk-focus-width`, `--sk-space-2`, `--sk-space-5`, `--sk-text-muted`, `--sk-text-primary`.

## Caveats and documentation

- Unordered list styling only; content is literal template data.
